...
class FiftyOneAnnotationApp:
    ...
    def _load_or_create_dataset(self) -> fo.Dataset:
        ...
        print(f"Added {dataset.size} files from directory:")
    ...
    def _initialize_review_status(self):
        ...
        print(f"Uninit review status using tag_review_status:", len(uninitialized))
        print(f'Initialized count using tag_review_status={len(self.dataset.match(F("tag_review_status").exists() == False))}')
        print(f'Initialized count using review_status={len(self.dataset.match(F("review_status").exists() == False))}')
        ...
        #     sample.save()
        uninitialized.set_values(                                                                                                        
            "tag_review_status",                                                                                                         
            [fo.Classification(label="todo")] * len(uninitialized)                                                                       
        )
